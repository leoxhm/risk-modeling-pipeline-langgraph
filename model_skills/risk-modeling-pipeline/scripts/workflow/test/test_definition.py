...
class WorkflowDefinitionTest(unittest.TestCase):
    def test_exposes_seven_engine_nodes_in_execution_order(self) -> None:
        self.assertEqual(
        ...
        self.assertEqual(len(MAIN_NODE_IDS), 7)
    ...
    def test_groups_internal_events_without_changing_the_audit_ids(self) -> None:
        ...
        self.assertEqual(main_node_for("model-report"), "model-config")
